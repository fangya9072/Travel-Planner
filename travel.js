  ...
  return $.get("https://api.openweathermap.org/data/2.5/weather?id=" + id + "&appid=ac141ae24c04ea59edfa71a5ab109b73",
                (response) => {
                    ...
                    if(weather.search("rain") != -1) {
                      document.getElementById("picture").src = "image/rainy.jpg";
                    }
                    if(weather.search("fog") != -1) {
                      document.getElementById("picture").src = "image/fog.jpg";
                    }
                    if(weather.search("clear") != -1) {
                      document.getElementById("picture").src = "image/clear.jpg";
                    }
                    if(weather.search("cloud") != -1) {
                      document.getElementById("picture").src = "image/cloudy.jpg";
                    }
                    if(weather.search("sun") != -1) {
                      document.getElementById("picture").src = "image/sunny.jpg";
                    }
                    if(weather.search("mist") != -1) {
                      document.getElementById("picture").src = "image/mist.jpg";
                    }
                    if(weather.search("snow") != -1) {
                      document.getElementById("picture").src = "image/snow.jpg";
                    }
                    if(weather.search("haze") != -1) {
                      document.getElementById("picture").src = "image/haze.jpg";
                    }
            ...
            $.ajax({
              ...
              success: function(response) {
                ...
                $.ajax( {
                  ...
                  error: function(){
                    console.log('locate destination airport failed');
                  }
                });
                ...
                $.ajax({
                  ...
                  error: function(){
                    console.log('locate departure airport failed');
                  }
                });
              },
              error: function(){
                console.log('locate instance failed');
              }
            });
          },
          error: function(){
